...
function SeatDetails(totalSeats, seats) {
    ...
    $.each(seats, function (i, itemSeat) {
        ...
        liElem += '<li' + AvailabilityClass(itemSeat.is_booked) + '><a href="javascript:void(0)" id="seat_' + itemSeat.seat_no + '" class="selectseat-link">' + itemSeat.seat_no + '</a></li>';

        if ((i + 1) > 1 && isTwelveRow == true) {

            if (centreSeat == i + 1) {

                liCenterElem += '<li><a href="#"></a></li><li><a href="#"></a></li><li><a href="#"></a></li><li><a href="#"></a></li><li><a href="#"></a></li><li><a href="#"></a></li><li><a href="#"></a></li><li><a href="#"></a></li><li><a href="#"></a></li><li><a href="#"></a></li><li><a href="#"></a></li><li><a href="#"></a></li>' + liElem;
    ...
    //$.each(seats, function (i, itemSeat) {
    //    if (i == 0 && i % 12 == 0) {
    //        $("#seatselection").append('<ul class="seatalign" id="seatalignment' + i + '">');
    //    }

    //    if (i % 12 == 1 && i > 0 && isTenRow == true) {

    //        if (centreSeat == i) {
    //            $("#seatselection").append('<ul class="seataligncenter" id="seatalignment' + i + '">');
    //        }
    //        else {
    //            $("#seatselection").append('<ul class="seatalign" id="seatalignment' + i + '">');
    //        }
    ...
    //    $("#seatselection").append('<li' + AvailabilityClass(itemSeat.is_booked) + '><a href="#">' + itemSeat.seat_no + '</a></li>');


    //    //if (isTenRow) {
    //    //if (centreSeat == i) {
    //    //    $("seataligncenter").append('<li' + AvailabilityClass(itemSeat.is_booked) + '><a href="#">' + itemSeat.seat_no + '</a></li>');
    //    //}
    //    //else {
...
function AvailabilityClass(isSeatBook) {
    var seatavailable = "";

    if (isSeatBook) {
        seatavailable = "class='active'";
    }
...
function CommaSeparatedString(oldStr, newStr) {
